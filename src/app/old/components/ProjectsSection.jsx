...
const projectsData = [
    ...
    },
    {
        id: 3,
        title: "Spotify Clone",
        description: "replicates the core functionalities of Spotify, allowing users to create an account, browse and search for songs, upload Songs, create playlists, and enjoy music playback.",
